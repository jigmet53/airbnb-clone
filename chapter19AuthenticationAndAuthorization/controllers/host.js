...
exports.getEditHome= (req,res,next)=>{
  ...
  res.render( 'host/edit-home',{pageTitle: 'Edit your home', currentPage: 'hostHome',editing:editing, home:home,  isLoggedIn:req.session.isLoggedIn,  user:req.session.user,})
...
res.render('host/host-home-list',{registeredHomes:registeredHomes,  pageTitle: 'host home ', currentPage: 'hostHome',  isLoggedIn:req.session.isLoggedIn,  user:req.session.user,});
